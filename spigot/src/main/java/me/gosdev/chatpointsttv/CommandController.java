...
public class CommandController implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        SpigotPlugin plugin = SpigotPlugin.getPlugin();
        if (plugin.isReloading()) {
            sender.sendMessage(ChatPointsTTV.PREFIX + ChatColor.RED + " The plugin is currently reloading. Please wait a moment.");
            return true;
    ...
    private void status(CommandSender p) {
        ...
        msg.addExtra(ChatColor.LIGHT_PURPLE + "Plugin Version: " + ChatColor.WHITE + SpigotPlugin.getPlugin().getDescription().getVersion());
