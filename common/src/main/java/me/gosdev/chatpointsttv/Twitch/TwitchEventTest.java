...
public class TwitchEventTest {
    ...
    public static ChannelChatMessageEvent CheerEvent(String channel, String chatter, Integer amount, Optional<String> message) {
        JSONObject json = new JSONObject();
        ...
        if (message.isPresent()) json.put("message", new JSONObject().put("text", message.get()));
    ...
    public static ChannelChatNotificationEvent SubEvent(String channel, String chatter, SubscriptionPlan plan, Optional<String> message) {
        JSONObject json = new JSONObject();
